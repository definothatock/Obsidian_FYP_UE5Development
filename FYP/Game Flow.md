...
What Possible Risk to Expect?
What Resource Management to Expect?
- See [[Core mechanics]].
...
## End Phase: Exiting
The only requirement for entering Exit: Met minimum loot.
...
- Failing the requirement
	- Locked out and forced to find a way to find more loot.
...
### Time Independent
- Creature encounter
	- Player might need/want to fight/avoid/hunt creatures. (May affect by time but does not rely on time)
- Radio Device Fixing
...
Extra: To encourage risk play, some thing might increase after time runs out:
